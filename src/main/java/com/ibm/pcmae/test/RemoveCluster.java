...
public class RemoveCluster extends APITestAdapter {
	private static final Logger logger = Logger.getLogger(RemoveCluster.class);
	...
	public void run() {
		...
		logger.info("------------------------------------------------------");
		Message message = api.removeCluster(id);
