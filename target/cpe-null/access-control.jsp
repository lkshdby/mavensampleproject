<%@page import="com.ibm.scas.analytics.backend.appdirect.AppDirectGatewayFactory"%>
<%@page import="com.google.inject.Injector"%>
<%@page import="javax.xml.crypto.dsig.keyinfo.RetrievalMethod"%>
<%@page import="com.ibm.scas.analytics.beans.NotificationResult"%>
<%@page import="com.ibm.scas.analytics.backend.appdirect.AppDirectGateway"%>
<%@page import="com.ibm.scas.analytics.utils.ExpiredPromoCodeException"%>
<%@page import="com.ibm.scas.analytics.utils.InvalidPromoCodeException"%>
...
<div class="ibm-columns" style="padding-top: 40px; overflow: visible">
	<div class="ibm-col-6-6">
		<div id="cpe-dashboard">
			<div data-dojo-type="platform/accesscontrol" data-dojo-props="offeringId: '<%=offeringId%>', offeringName: '<%=offeringName%>', subOfferingName: '<%=subOfferingName%>', email: '<%=email%>', accessCode: '<%=accessCode%>', retry: <%=retry%>, contextUrl: '<%=contextPath%>/dynamic/<%=offering.getUrlPath()%>'"></div>
		</div>
	</div>
</div>
<!-- BEGIN CPE CONTENT -->
