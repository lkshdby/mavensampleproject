...
function SmartWizard(target, options) {
    ...
    this.contentWidth = 0;
    this.msgBox = $('<div class="msgBox"><div class="title"><span class="titleMsg"></span><img class="titleImage" src=""></img></div><div class="content"></div><div class="close"><a href="#">OK</a></div></div>');
    ...
    this.buttons = {
        ...
        cancel  : $('<a>'+options.labelCancel+'</a>').attr("href","#").addClass("buttonCancel")
    };
    ...
    var _init = function($this) {
        ...
        //Change - 29/06/2015 - change sequence buttton
        ...
        $($this.buttons.cancel).click(function() {
        	if($.isFunction($this.options.onCancel)) {
        		if(!$this.options.onCancel.call(this)){
                    return false;
                }
        	}
            return false;
        ...
        $($this.steps).bind("click", function(e){
            ...
            if(isDone == 1){
                _loadContent($this, nextStepIdx, false);
            }
            return false;
        });
        ...
        _loadContent($this, $this.curStepIdx, false);
    };
    ...
    var _loadContent = function($this, stepIdx, callBeforeShowStep) {
    	
    	var selStep = $this.steps.eq(stepIdx);
        var curStep = $this.steps.eq($this.curStepIdx);
    	
    	if(callBeforeShowStep && $.isFunction($this.options.beforeShowStep)) {
            var context = { fromStep: parseInt($(curStep).attr('rel')), toStep: parseInt($(selStep).attr('rel')) };
            if(! $this.options.beforeShowStep.call(this,$(selStep),context)){
                return false;
            }
        }
    ...
    SmartWizard.prototype.goForward = function(){
        ...
        _loadContent(this, nextStepIdx, true);
    };
    ...
    SmartWizard.prototype.goToStep = function(stepNum){
        ...
        if (stepIdx >= 0 && stepIdx < this.steps.length) {
            _loadContent(this, stepIdx, false);
        }
    };
    ...
    SmartWizard.prototype.showMessage = function (title, msg, imagePath) {
    	$('.titleMsg', this.msgBox).html(title);
    	$('.titleImage', this.msgBox).attr('src',imagePath);
...
// Default Properties and Events
    $.fn.smartWizard.defaults = {
        ...
        beforeShowStep: null, // Added by Bhushan 02/07/2015 - trigger before showing step details
        onFinish: null,  // triggers when Finish button is clicked
        includeFinishButton : true,   // Add the finish button
        includeCancelButton : true   // Add the Cancel button
    };
